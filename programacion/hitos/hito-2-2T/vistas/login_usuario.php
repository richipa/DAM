...
<head>
    ...
    <title>Iniciar Sesión - TareasWeb</title>
    <style>
        body {
...
<body>
    ...
    <div class="login-container">
        ...
        <form method="POST" action="../controlador/UsuariosController.php">
            <input type="hidden" name="accion" value="loginUsuario"> <!-- Acción para el controlador -->
            ...
            <div class="d-grid">
                <button style="font-family: monospace;" type="submit" class="btn btn-warning">Iniciar Sesión</button>
            </div>
