...
class Conexion {
    ...
    private $base_datos = 'StreamWeb'; // Nombre de la base de datos a la que se quiere conectar
    ...
    public function __construct() {
        ...
        if ($this->conexion->connect_error) {
            ...
            // Si la conexión fue exitosa, muestra un mensaje de éxito en la consola del navegador
